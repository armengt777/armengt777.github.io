...
// stage content:
(lib.slide1animation = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{},true);
	
	this.text1 = getCJSElement("TEXT",{compId:"ID_s1_txt01",
								width:120,align:"right",expand:"up",div:"slide_1",
								size:12});
	this.addChild(this.text1);
	
	this.text2 = getCJSElement("TEXT",{compId:"ID_s1_txt02",
								width:150,align:"left",expand:"down",div:"slide_1",
								size:12});
	this.addChild(this.text2);
	this.text2.visible = false;
	
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text1,p:{regX:41.3,x:187.39999999999998,y:163.2}}]}).to({state:[{t:this.text2,p:{visible:true, regX:70.5,x:360.65000000000003,y:232.9}}]},45).wait(91));
