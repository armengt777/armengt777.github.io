...
(SyntaxComp = function (o) {
	...
	t.cd = function()
	{
		...
		//$("#"+o.compId+"_prompt_"+cC).attr("spellcheck",'false');
		...
		if(id == "check")
		{
			...
			for(i = 0;i<dropArray.length;i++)
			{
				...
				if(dropArray[i].dragTarget && dropArray[i].obj.match!="null")
				{
					...
					//console.log("___________"+dragArray[dragId].obj.group)
				//	console.log("this is dragId ::::"+dragId );
